    ...
    return (
        <>
            <div className="flex flex-col lg:gap-8 gap-4">
                {(props.loading) ? (
                    <>
                        <div className="flex flex-row justify-center items-center align-middle shadow-md rounded-md w-full p-5 lg:p-10">
                            <div className="flex flex-col justify-center w-full lg:w-11/12 gap-3">
...
function ItemComp(props) {
    ...
    return (
        <>
            <div className="flex flex-row gap-5 justify-center items-center align-middle shadow-md rounded-md w-full p-5 lg:p-10">
                ...
                <div className="flex flex-col justify-center w-11/12 gap-3">
                    ...
                    <p className="text-start text-sm mb-2 font-light text-slate-700 break-all">{props.desc}</p>
                    <div className="flex flex-row align-middle items-center gap-5">
                        {
                            ...
                            <>
<div className="flex flex-col lg:flex-row w-full lg:gap-6 gap-3">
    <div className="border rounded-md shadow-sm ring-2 ring-blue-700 flex flex-row items-center justify-center p-2">
        <FontAwesomeIcon icon={faPlusCircle} className="text-blue-700 mr-2" />
        <p className="text-sm lg:text-base">{dateSeparator(props.date_added)}</p>
    </div>
    <div className="border rounded-md shadow-sm ring-2 ring-yellow-400 flex flex-row items-center justify-center p-2 mt-3 lg:mt-0">
        <FontAwesomeIcon icon={faHourglass1} className="text-yellow-400 mr-2" />
        <p className="text-sm lg:text-base">{dateSeparator(props.deadline)}</p>
    </div>
    <div className="border rounded-md shadow-sm ring-2 ring-red-400 flex flex-row items-center justify-center p-2 mt-3 lg:mt-0">
        ...
        <p className="text-sm lg:text-base">
            {new Date(props.deadline).getTime() - new Date().getTime() < 0 ? (
                ...
                Math.floor((new Date(props.deadline).getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24)) + ' day(s) left'
            )}
        </p>
    </div>
</div>
