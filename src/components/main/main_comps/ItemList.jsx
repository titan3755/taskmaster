    ...
    return (
        <>
            <div className="flex flex-col md:gap-8 gap-4">
                {(props.loading) ? (
                    <>
                        <div className="flex flex-row justify-center items-center align-middle shadow-md rounded-md w-full p-5 md:p-10">
                            <div className="flex flex-col justify-center w-full md:w-11/12 gap-3">
...
function ItemComp(props) {
    ...
    return (
        <>
            <div className="flex flex-row gap-5 justify-center items-center align-middle shadow-md rounded-md w-full p-5 md:p-10">
                    ...
                    <div className="flex flex-row align-middle items-center gap-5">
                        {
                            ...
                            <>
                                <div className="flex md:flex-row md:gap-6 gap-3 flex-col w-full">
